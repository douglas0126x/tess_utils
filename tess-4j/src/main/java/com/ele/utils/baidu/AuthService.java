...
public class AuthService {
    ...
    public static String getAuth() {
        // 获取token地址
    	 String authHost = AppClientConstant.getBaiduTokenUrl();
        // 官网获取的 API Key 更新为你注册的
        String clientId = AppClientConstant.getApiKeyFace();
        // 官网获取的 Secret Key 更新为你注册的
        String clientSecret = AppClientConstant.getSecretKeyFace();
