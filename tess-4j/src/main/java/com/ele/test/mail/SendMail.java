...
public class SendMail {
	...
	public static void main(String[] args) {
		String smtp = "smtp.aliyun.com"; // "SMTP服务器";
		String from = "yaoxiaojun@ele-cloud.com";// "发信人";
		String to = "2604222937@qq.com";
		// 收信人
		String copyto = "chenchengjie@ele-cloud.com";// "抄送人";
		String subject = "this is a test"; // "邮件主题";
		String content = "下午好，休息会吧！！";// "邮件内容";
		String username = "yaoxiaojun@ele-cloud.com";// "用户名";
		String password = "root1234#";// "密码";
		String filename = "F:/generate_test/title.png";// "附件路径，如：d:\\test.jpg;
